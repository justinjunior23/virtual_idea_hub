...
urlpatterns = [
    ...
    path( 'admin/notifications/', views.notifications_partial, name='notifications_partial' ),
    path( 'admin/activity/', views.activity_partial, name='activity_partial' ),
    path( 'admin/all-submissions/', views.all_submissions_partial, name='all_submissions_partial' ),
    path( 'admin/innovations/', views.innovations_partial, name='innovations_partial' ),
    path( 'admin/suggestions/', views.suggestions_partial, name='suggestions_partial' ), 
    path( 'admin/complaints/', views.complaints_partial, name='complaints_partial' ), 
    path( 'admin/emergencies/', views.emergencies_partial, name='emergencies_partial' ), 
    path( 'admin/awareness/', views.awareness_partial, name='awareness_partial' ), 
    path( 'admin/anonymous/', views.anonymous_partial, name='anonymous_partial' ), 
    path( 'admin/pending/', views.pending_partial, name='pending_partial' ),
    path( 'admin/assigned/', views.assigned_partial, name='assigned_partial' ), 
    path( 'admin/resolved/', views.resolved_partial, name='resolved_partial' ), 
    path( 'admin/archived/', views.archived_partial, name='archived_partial' ),
    path( 'admin/departments/', views.departments_partial, name='departments_partial' ),
    path( 'admin/performance/', views.performance_partial, name='performance_partial' ),
    path( 'admin/staff-responses/', views.staff_responses_partial, name='staff_responses_partial' ),
    path( 'admin/staff-management/', views.staff_management_partial, name='staff_management_partial' ), 
    path( 'admin/roles/', views.roles_partial, name='roles_partial' ),
    path( 'admin/export/', views.export_partial, name='export_partial' ), 
    path( 'admin/monthly/', views.monthly_partial, name='monthly_partial' ), 
    path( 'admin/audit/', views.audit_partial, name='audit_partial' ), 
    path( 'admin/settings/', views.settings_partial, name='settings_partial' ),
    path( 'admin/email-templates/', views.email_templates_partial, name='email_templates_partial' ), 
    path( 'admin/security/', views.security_partial, name='security_partial' ),
